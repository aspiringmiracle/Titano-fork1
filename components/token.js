          ...
          <div className="flex flex-col">
            <div className="flex items-center h-full">
              <div className="content-center">
                <div>
                  <h2 className="text-3xl">Mumbai Tokenomics Explained</h2>
                </div>
                <div className="my-10">
                  <div>
                ...
                <div  className="mt-4">
                  <p className="text-md leading-10">$MUMBAI is a BEP-20 token with an elastic supply that rewards holders using a positive rebase formula.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col w-full">
                <div className="m-1 pd-4 token-container">
                  ...
                  <p className="leading-10 text-center">
                      5% of the trading fees return to the liquidity ensuring $MUMBAI's increasing collateral value.
                  </p>
                </div>
              </div>
              <div className="flex flex-col w-full">
